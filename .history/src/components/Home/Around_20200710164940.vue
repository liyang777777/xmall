<template>
  ...
  <div class="All">
    <div class="Around">
      ...
      <div class="List">
        <div v-for="(item,index) in around" :key="index" class="hotList" :class="'hotList'+index">
          <div class="picture">
          ...
          <div class="btn">
            <span class="see">
              <Button @click="gotoDetails(item)">查看详情</Button>
            </span>
            <span>
...
.hotList0 {
  ...
  &:hover {
    cursor: pointer;
    box-shadow: 15px 10px 10px -8px rgb(185, 183, 183);
    height: 495px;
    translate: 0 -20px 20px;
    transition: all 0.5s;
    .salePrice {
      display: none;
    }
